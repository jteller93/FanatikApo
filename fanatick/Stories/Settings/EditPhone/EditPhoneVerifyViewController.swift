//
//  EditPhoneVerifyViewController.swift
//  fanatick
//
...
class EditPhoneVerifyViewController: ViewController {
    var viewModel = EditPhoneVerifyViewModel()
    ...
    override func applyStyling() {
        ...
        titleLabel.text = String(format: LocalizedString("verification_code_title", story: .authentication), FirebaseSession.shared.displayedUpdatedPhoneNumber)
        ...
        verifyButton.setTitle(LocalizedString("update"), for: .normal)
        ...
        viewModel.resendSuccess.subscribe(onNext: { [weak self] (_) in
            self?.showMessage(title: "",
                              message: String(format: LocalizedString("verification_code_resend",
                                              ...
                                              FirebaseSession.shared.displayedUpdatedPhoneNumber))
        }).disposed(by: disposeBag)
